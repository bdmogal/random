...
public class WordLadder {
    ...
    private static class WordGraph {
        ...
        public void addEdge(String vertex1, String vertex2) {
            Set<String> vertex1AdjList = null;
            if (adjacencyLists.containsKey(vertex1)) {
                vertex1AdjList = adjacencyLists.get(vertex1);
            }
            else {
                vertex1AdjList = new HashSet<String>();
                adjacencyLists.put(vertex1, vertex1AdjList);
            }
            vertex1AdjList.add(vertex2);
        }
        ...
        private boolean isNeighbor(String vertex1, String vertex2) {
            if (vertex1.length() != vertex2.length()) {
                throw new IllegalArgumentException("Words with different lengths are illegal!");
            }
            int distance = 0;
            for (int i = 0; i < vertex1.length(); i++) {
                if (vertex1.charAt(i) != vertex2.charAt(i)) {
                    distance++;
                }
        ...
        public Set<String> adj(String vertex) {
            return adjacencyLists.get(vertex);
        }
    }


    public static int pathLength(String word1, String word2) {
        if (!ALL_WORDS.contains(word1)) {
            throw new IllegalArgumentException(word1 + " not found in dictionary!");
        }
        if (!ALL_WORDS.contains(word2)) {
            throw new IllegalArgumentException(word2 + " not found in dictionary!");
        }
        ...
        while (!queue.isEmpty()) {
            ...
            Set<String> adjacents = graph.adj(popped);
            if (adjacents != null) {
        ...
        if(!pathFound) {
            System.out.println("Couldn't find path between " + word1 + " and " + word2);
            return -1;
        }
        List<String> path = new LinkedList<String>();
        for (String last = word2; last != null; last = prev.get(last)) {
            path.add(last);
        }
    ...
    private static void print(List<String> visited) {
    ...
    public static void main(String [] args) {
        WordLadder.pathLength("HEAD", "TAIL");
